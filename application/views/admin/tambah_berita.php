...
<form action="<?= base_url('admin/tambahAksi') ;?>" method="POST" enctype="multipart/form-data">
	<div class="form-group">
		<label for="judulBerita">Judul Berita</label>
		<input type="text" name="judulBerita" class="form-control" id="judulBerita" placeholder="Judul Berita" required autocomplete>
		<?= form_error('judulBerita', '<div class="text-danger small ml-3">','</div>') ;?>
	</div>
	<div class="form-group">
		<label for="namaPengarang">Nama Pengarang</label>
		<input type="text" name="namaPengarang" class="form-control" id="namaPengarang" placeholder="Nama Pengarang" required autocomplete>
		<?= form_error('namaPengarang', '<div class="text-danger small ml-3">','</div>') ;?>
	</div>
	<!-- <div class="form-group">
		<label for="headlineBerita">Headline Berita</label>
		<input type="text" name="headlineBerita" class="form-control" id="headlineBerita" placeholder="Headline Berita" required autocomplete>
	...
	<div class="form-group">
		...
		<select class="form-control" name="idKategori" id="kategoriBerita">
			<?php foreach ($tKategori as $tk): ?>
				<option value="<?= $tk['idKategoriBerita'] ?>"><?= $tk['namaKategoriBerita'] ;?></option>
			<?php endforeach ?>
		</select>
	</div>
	<div class="form-group">
		<label for="isiBerita">Description Berita</label>
		<textarea name="isiBerita" id="editor" class="form-control" rows="10"></textarea>
	...
	<div class="form-group">
		...
		<input type="text" name="ratingBerita" class="form-control" id="ratingBerita" placeholder="Rating Berita" required autocomplete>
