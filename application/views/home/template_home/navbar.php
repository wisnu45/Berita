    ...
    <div class="navbar" role="navigation">
      ...
      <div class="navbar-collapse collapse">
        ...
        <ul class="nav navbar-nav right">
          <li><a href="<?= base_url('assets/news/') ;?>index.html">Home<i class="fa fa-angle-down"></i></a>
            <ul class="dropdown-menu">
              <li><a href="<?= base_url('assets/news/') ;?>index-full-width.html">Full Width Blog</a></li>
              <li><a href="#">Masonry Blog<i class="fa fa-angle-right"></i></a>
                <ul class="dropdown-menu">
                  <li><a href="<?= base_url('assets/news/') ;?>3column.html">3 Column Full</a></li>
                  <li><a href="<?= base_url('assets/news/') ;?>2column-sidebar.html">2 Column with Sidebar</a></li>
                </ul>
              </li> 
              <li><a href="<?= base_url('assets/news/') ;?>index2.html">Style 2</a></li>
            </ul>
          </li>
