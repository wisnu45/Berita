...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 24 Nov 2020 pada 09.26
...
CREATE TABLE `t_kategori_berita` (
  `idKategoriBerita` int(11) NOT NULL,
...
CREATE TABLE `t_konfigurasi_user` (
...
(9, 'Admin fajri', 'admin', 'Admin@gmail.com', 'bc1fffd11594a657f4b9c4ec6e82aa418f4f906c18aa5674bddde60eeb12cf7cb25a26fcbd2d114a0fd900ac9ea35aede9d904807701b1bbd523be226b9633a9', 'pria', '082287770991', 'koto baru kubang putiah sdf', '1600771297', '1604594567', '76b67e8838d701d1628f57e577536b9c.png', 'admin', 'aktif', 0, '1606152279', 'tidak'),
...
(17, 'fajri wilsher', 'fajri20', 'fajriwilsher30@gmail.com', 'bc1fffd11594a657f4b9c4ec6e82aa418f4f906c18aa5674bddde60eeb12cf7cb25a26fcbd2d114a0fd900ac9ea35aede9d904807701b1bbd523be226b9633a9', NULL, NULL, NULL, '1602090200', '1602090200', 'default.jpg', 'user', 'aktif', 0, '0', 'tidak');
...
CREATE TABLE `t_menu_front` (
  `idMenuFront` int(11) NOT NULL,
...
CREATE TABLE `t_submenu_backend` (
...
--
-- Indeks untuk tabel `t_about`
--
ALTER TABLE `t_about`
  ADD PRIMARY KEY (`idAbout`);

--
-- Indeks untuk tabel `t_access`
--
...
--
-- Indeks untuk tabel `t_kategori_berita`
--
ALTER TABLE `t_kategori_berita`
  ADD PRIMARY KEY (`idKategoriBerita`);
...
--
-- Indeks untuk tabel `t_konfigurasi_user`
--
ALTER TABLE `t_konfigurasi_user`
...
--
-- Indeks untuk tabel `t_menu_backend`
--
ALTER TABLE `t_menu_backend`
  ADD PRIMARY KEY (`idMenu`);

--
-- Indeks untuk tabel `t_menu_front`
--
ALTER TABLE `t_menu_front`
  ADD PRIMARY KEY (`idMenuFront`);
...
--
-- Indeks untuk tabel `t_submenu_backend`
--
ALTER TABLE `t_submenu_backend`
...
--
-- AUTO_INCREMENT untuk tabel `t_about`
--
ALTER TABLE `t_about`
  MODIFY `idAbout` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT untuk tabel `t_access`
--
ALTER TABLE `t_access`
  MODIFY `idAccess` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
--
ALTER TABLE `t_gambar`
  MODIFY `idGambar` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT untuk tabel `t_kategori_berita`
--
ALTER TABLE `t_kategori_berita`
  MODIFY `idKategoriBerita` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
...
--
-- AUTO_INCREMENT untuk tabel `t_konfigurasi_user`
--
ALTER TABLE `t_konfigurasi_user`
...
--
-- AUTO_INCREMENT untuk tabel `t_menu_backend`
--
ALTER TABLE `t_menu_backend`
  MODIFY `idMenu` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;

--
-- AUTO_INCREMENT untuk tabel `t_menu_front`
--
ALTER TABLE `t_menu_front`
  MODIFY `idMenuFront` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
--
-- AUTO_INCREMENT untuk tabel `t_submenu_backend`
--
ALTER TABLE `t_submenu_backend`
